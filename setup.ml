(* OASIS_START *)
(* DO NOT EDIT (digest: 866ccde23a69e6eb244ff70bfa5e8cc4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_typerep_conv";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "pb\209(~=\151\149\136\249\186\199\001\220\007d";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
